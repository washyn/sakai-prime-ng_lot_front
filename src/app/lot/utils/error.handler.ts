...
export class ErrorHandler {
    ...
    private handleError(err: any) {
        ...
        if (
            ...
            err.headers.get('Abp-Tenant-Resolve-Error')
        ) {
            ...
            switch (err.status) {
                case 401:
                    this.canCreateCustomError(401)
                        ...
                        : this.showError(
                              {
                                  key: DEFAULT_ERROR_LOCALIZATIONS
                                      .defaultError401.title,
                                  defaultValue:
                                      DEFAULT_ERROR_MESSAGES.defaultError401
                                          .title,
                              },
                              {
                                  key: DEFAULT_ERROR_LOCALIZATIONS
                                      .defaultError401.details,
                                  defaultValue:
                                      DEFAULT_ERROR_MESSAGES.defaultError401
                                          .details,
                              }
                ...
                case 403:
                    this.createErrorComponent({
                        title: {
                            key: DEFAULT_ERROR_LOCALIZATIONS.defaultError403
                                .title,
                            defaultValue:
                ...
                case 404:
                    this.canCreateCustomError(404)
                        ...
                        : this.showError(
                              {
                                  key: DEFAULT_ERROR_LOCALIZATIONS
                                      .defaultError404.details,
                                  defaultValue:
                                      DEFAULT_ERROR_MESSAGES.defaultError404
                                          .details,
                              },
                              {
                                  key: DEFAULT_ERROR_LOCALIZATIONS
                                      .defaultError404.title,
                                  defaultValue:
                                      DEFAULT_ERROR_MESSAGES.defaultError404
                                          .title,
                              }
                ...
                case 500:
                    this.createErrorComponent({
                        title: {
                            key: DEFAULT_ERROR_LOCALIZATIONS.defaultError500
                                .title,
                            defaultValue:
                ...
                case 0:
                    if (err.statusText === 'Unknown Error') {
                        this.createErrorComponent({
                            title: {
                                key: DEFAULT_ERROR_LOCALIZATIONS.defaultError
                                    .title,
                                defaultValue:
    ...
    createErrorComponent(instance: Partial<HttpErrorWrapperComponent>) {
        ...
        for (const key in instance) {
            ...
            if (
                ...
                (this.componentRef.instance as any)[key] = (instance as any)[
                    key
                ];
            }
        }
        ...
        if (
            this.canCreateCustomError(instance.status as ErrorScreenErrorCodes)
        ) {
    ...
    canCreateCustomError(status: ErrorScreenErrorCodes): boolean {
        return !!(
            ...
            this.httpErrorConfig?.errorScreen?.forWhichErrors.indexOf(status) >
                -1
        );
    }
